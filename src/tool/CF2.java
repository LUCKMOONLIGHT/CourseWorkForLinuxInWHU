...
public class CF2 {
    ...
    public static void main(String[] args) {
        Map<String, Map<String, Integer>> userBiao = new HashMap<String, Map<String, Integer>>();
        ...
        pref5.put("E", 1);
        pref5.put("F", 0);
        userBiao.put("p5", pref5);

        Map<String, Double> simUserSimMap = new HashMap<String, Double>();
        System.out.println("皮尔逊相关系数:");

        for (Entry<String, Map<String, Integer>> userPerfEn : userBiao.entrySet()) {
            String userName = userPerfEn.getKey();
            if (!"p5".equals(userName)) {
                double sim = getUserSimilar(pref5, userPerfEn.getValue());//相关系数
