...
//猜你喜欢
public class SeasonRecommendation extends JPanel implements ActionListener {
	...
	public SeasonRecommendation(Tool tool,Data data){
		...
		index = 0;
		this.init(tool);
		setViewList(1);//推荐方法选择，1、用户推荐。2、景点相似推荐
		this.add(likeButton);
